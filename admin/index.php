...
<head>
    ...
    <title><?php echo ucwords(str_replace('_',' ',$page)) ?> | Online Test System</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'enrollees')? 'active' : '' ?>" href="./?page=enrollees"><i class="fa fa-user-tie"></i> Enrollees</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'report_list')? 'active' : '' ?>" href="./?page=report_list"><i class="fa fa-th-list"></i> Report</a>
                    </li>
                    <?php if($_SESSION['type'] == 1): ?>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'exams')? 'active' : '' ?>" href="./?page=exams"><i class="fa fa-th-list"></i> Exam Set</a>
                    </li>
                    <li class="nav-item">
